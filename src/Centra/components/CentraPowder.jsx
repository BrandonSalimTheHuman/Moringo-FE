...
const CentraPowder = () => {
        ...
        if (response.ok) {
          ...
          try {
            ...
            const batchResponse = await fetch(
              `https://moringo-be.vercel.app/centra/dried_leaves_batches?centra_name=${data.branch}`,
              {
                method: 'GET',
                headers: {
                  'Content-Type': 'application/json',
  ...
  const handleStartPowderProduction = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `https://moringo-be.vercel.app/centra/start_powder_machine/${branch}`,
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
      ...
      if (response.ok) {
        ...
        try {
          ...
          const response = await fetch(
            `https://moringo-be.vercel.app/update_processing`,
            {
              method: 'PUT',
              headers: {
                'Content-Type': 'application/json',
  ...
  const handleInputPowder = async () => {
    ...
    try {
      ...
      const response = await fetch(
        'https://moringo-be.vercel.app/centra/powder_results',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
      ...
      if (response.ok) {
        ...
        try {
          const token = localStorage.getItem('token');
          const response = await fetch(
            `https://moringo-be.vercel.app/centra/powder_batch?centra_name=${branch}&production_date=${formattedInputDate}`,
            {
              method: 'GET',
              headers: {
                'Content-Type': 'application/json',
          ...
          if (response.ok) {
            ...
            try {
              ...
              const response = await fetch(
                `https://moringo-be.vercel.app/centra/powder_machine_update_status`,
                {
                  method: 'POST',
                  headers: {
                    'Content-Type': 'application/json',
              ...
              if (response.ok) {
                ...
                try {
                  ...
                  const response = await fetch(
                    `https://moringo-be.vercel.app/centra/dried_batches`,
                    {
                      method: 'DELETE',
                      headers: {
                        'Content-Type': 'application/json',

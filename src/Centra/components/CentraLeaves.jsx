...
const CentraLeaves = () => {
      ...
      try {
        ...
        if (branch) {
          ...
          const machineResponse = await fetch(
            `https://moringo-be.vercel.app/centra/drying_machine_remaining_time/${branch}`,
            {
              method: 'GET',
              headers: {
                'Content-Type': 'application/json',
          ...
          const batchResponse = await fetch(
            `https://moringo-be.vercel.app/centra/moringa_batches?centra_name=${branch}`,
            {
              method: 'GET',
              headers: {
                'Content-Type': 'application/json',
  ...
  const updateDatabaseWeight = async () => {
    try {
      ...
      const response = await fetch(
        'https://moringo-be.vercel.app/centra/drying_machine_update_weight',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  const handleAddBatch = async () => {
    ...
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(
        'https://moringo-be.vercel.app/centra/moringa_batches',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  const handleConfirmEdit = async () => {
    ...
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(
        `https://moringo-be.vercel.app/centra/moringa_batches/${batchToEdit.batchId}`,
        {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
  ...
  const handleStartProduction = async () => {
    ...
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(
        `https://moringo-be.vercel.app/centra/start_machine/${branch}`,
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  const handleInputDry = async () => {
    ...
    try {
      ...
      const response = await fetch(
        'https://moringo-be.vercel.app/centra/drying_results',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
      ...
      if (response.ok) {
        ...
        try {
          const token = localStorage.getItem('token');
          const response = await fetch(
            `https://moringo-be.vercel.app/centra/dried_leaves_batch?centra_name=${branch}&production_date=${formattedInputDate}`,
            {
              method: 'GET',
              headers: {
                'Content-Type': 'application/json',
            ...
            try {
              ...
              if (response.ok) {
                ...
                try {
                  ...
                  const response = await fetch(
                    `https://moringo-be.vercel.app/centra/moringa_batches/all`,
                    {
                      method: 'DELETE',
                      headers: {
                        'Content-Type': 'application/json',
